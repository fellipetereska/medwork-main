          ...
          <div className="fixed z-50 m-2 -mt-4">
            <div className={`bg-gray-700 rounded-lg px-6 py-2 ${visible ? 'block' : 'hidden'} text-white`}>
              ...
              <div>
                ...
                <p className="mb-2 text-justify font-light text-gray-300 flex">
                  Complementando a página, disponibilizamos uma tabela organizada com os dados dos contatos, incluindo informações relevantes como nome, cargo, empresa e unidade de atuação. Na mesma linha, são apresentados três botões distintos: um ícone de lápis para edição, um ícone de corrente para vincular contatos a setores ou unidades, e um checkbox para desativar o contato, se necessário. O ícone de edição permite ajustes no contato.
                </p>
                <p className="mb-2 text-justify font-light text-gray-300 flex">
